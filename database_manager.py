...
class PeerEntity(BaseEntity):
    ...
    platform: str = Column(Text, nullable=True)
...
class TokenEntity(BaseEntity):
    ...
    __table_args__ = (UniqueConstraint("account_id", "peer_id", name="account_peer_exist"),)
    ...
    # 登录设备ID
    peer_id: str = Column(Text, ForeignKey('rustdesk_peers.id', ondelete='CASCADE'), nullable=False)
    ...
    # 关联的客户端设备
    peer: PeerEntity = relationship("PeerEntity")
